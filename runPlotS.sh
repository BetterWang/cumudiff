...
#
#
#root -l -b -q 'plotS.C("PbPb2018_Lm_corrected.root:grSig_pT2_1_1;PbPb2018_LmSBPos_corrected.root:grSig_pT2_1_1;PbPb2018_LmSBNeg_corrected.root:grSig_pT2_1_1", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{#Lambda 5-10\%}",  "Lm_v24_sysSB_1", 0, 0.3, 6)'
#root -l -b -q 'plotS.C("PbPb2018_Lm_corrected.root:grSig_pT2_1_2;PbPb2018_LmSBPos_corrected.root:grSig_pT2_1_2;PbPb2018_LmSBNeg_corrected.root:grSig_pT2_1_2", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{#Lambda 10-30\%}", "Lm_v24_sysSB_2", 0, 0.3, 6)'
#root -l -b -q 'plotS.C("PbPb2018_Lm_corrected.root:grSig_pT2_1_3;PbPb2018_LmSBPos_corrected.root:grSig_pT2_1_3;PbPb2018_LmSBNeg_corrected.root:grSig_pT2_1_3", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{#Lambda 30-50\%}", "Lm_v24_sysSB_3", 0, 0.3, 6)'
#root -l -b -q 'plotS.C("PbPb2018_Lm_corrected.root:grSig_pT2_1_4;PbPb2018_LmSBPos_corrected.root:grSig_pT2_1_4;PbPb2018_LmSBNeg_corrected.root:grSig_pT2_1_4", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{#Lambda 50-80\%}", "Lm_v24_sysSB_4", 0, 0.3, 6)'
#
#root -l -b -q 'plotS.C("PbPb2018_Ks_corrected.root:grSig_pT2_1_1;PbPb2018_KsSBPos_corrected.root:grSig_pT2_1_1;PbPb2018_KsSBNeg_corrected.root:grSig_pT2_1_1", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{K_{S}^{0} 5-10\%}",  "Ks_v24_sysSB_1", 0, 0.3, 4)'
#root -l -b -q 'plotS.C("PbPb2018_Ks_corrected.root:grSig_pT2_1_2;PbPb2018_KsSBPos_corrected.root:grSig_pT2_1_2;PbPb2018_KsSBNeg_corrected.root:grSig_pT2_1_2", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{K_{S}^{0} 10-30\%}", "Ks_v24_sysSB_2", 0, 0.3, 4)'
#root -l -b -q 'plotS.C("PbPb2018_Ks_corrected.root:grSig_pT2_1_3;PbPb2018_KsSBPos_corrected.root:grSig_pT2_1_3;PbPb2018_KsSBNeg_corrected.root:grSig_pT2_1_3", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{K_{S}^{0} 30-50\%}", "Ks_v24_sysSB_3", 0, 0.3, 4)'
#root -l -b -q 'plotS.C("PbPb2018_Ks_corrected.root:grSig_pT2_1_4;PbPb2018_KsSBPos_corrected.root:grSig_pT2_1_4;PbPb2018_KsSBNeg_corrected.root:grSig_pT2_1_4", "v_{2}^{Sig}{4} Std;v_{2}^{Sig}{4} SB+;v_{2}^{Sig}{4} SB-", "#splitline{PbPb 5.02 TeV}{K_{S}^{0} 50-80\%}", "Ks_v24_sysSB_4", 0, 0.3, 4)'
#
#
...
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_1_6;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_6;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_1_6;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_2_6;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_3_6", "v_{2}{4};v_{2}{4} veto Jet;v_{2}{4} Jet Only;v_{2}{6} Jet Only;v_{2}{8} Jet Only", "#splitline{pPb 8.16 TeV}{Ch 120 #leq N_{trk}^{offline} < 150}", "Pt_v24Jet_6", 1, 9.5)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_1_7;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_7;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_1_7;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_2_7;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_3_7", "v_{2}{4};v_{2}{4} veto Jet;v_{2}{4} Jet Only;v_{2}{6} Jet Only;v_{2}{8} Jet Only", "#splitline{pPb 8.16 TeV}{Ch 150 #leq N_{trk}^{offline} < 185}", "Pt_v24Jet_7", 1, 9.5)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_1_8;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_8;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_1_8;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_2_8;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_3_8", "v_{2}{4};v_{2}{4} veto Jet;v_{2}{4} Jet Only;v_{2}{6} Jet Only;v_{2}{8} Jet Only", "#splitline{pPb 8.16 TeV}{Ch 185 #leq N_{trk}^{offline} < 250}", "Pt_v24Jet_8", 1, 9.5)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_1_9;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_9;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_1_9;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_2_9;../cumudiff/pPb_H_Jet20eta20_merged2_corrected.root:grSig_pT2_3_9", "v_{2}{4};v_{2}{4} veto Jet;v_{2}{4} Jet Only;v_{2}{6} Jet Only;v_{2}{8} Jet Only", "#splitline{pPb 8.16 TeV}{Ch N_{trk}^{offline} #geq 250}",       "Pt_v24Jet_9", 1, 9.5)'
#
...
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_6;../cumudiff/pPb_H_vetoakPu4Jet20eta20_JER_merged2_corrected.root:grSig_pT2_1_6", "v_{2}{4,veto};v_{2}{4,veto} JER 20\%", "#splitline{pPb 8.16 TeV}{Ch 120 #leq N_{trk}^{offline} < 150}", "Pt_v4sysvetoJetJER_6", 0, 0.2)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_7;../cumudiff/pPb_H_vetoakPu4Jet20eta20_JER_merged2_corrected.root:grSig_pT2_1_7", "v_{2}{4,veto};v_{2}{4,veto} JER 20\%", "#splitline{pPb 8.16 TeV}{Ch 150 #leq N_{trk}^{offline} < 185}", "Pt_v4sysvetoJetJER_7", 0, 0.2)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_8;../cumudiff/pPb_H_vetoakPu4Jet20eta20_JER_merged2_corrected.root:grSig_pT2_1_8", "v_{2}{4,veto};v_{2}{4,veto} JER 20\%", "#splitline{pPb 8.16 TeV}{Ch 185 #leq N_{trk}^{offline} < 250}", "Pt_v4sysvetoJetJER_8", 0, 0.2)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_1_9;../cumudiff/pPb_H_vetoakPu4Jet20eta20_JER_merged2_corrected.root:grSig_pT2_1_9", "v_{2}{4,veto};v_{2}{4,veto} JER 20\%", "#splitline{pPb 8.16 TeV}{Ch N_{trk}^{offline} #geq 250}",       "Pt_v4sysvetoJetJER_9", 0, 0.2)'
...
##### standard vs vetoakPu4Jet20eta20 v28
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_3_6;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_3_6", "v_{2}{8};v_{2}{8,veto}", "#splitline{pPb 8.16 TeV}{Ch 120 #leq N_{trk}^{offline} < 150}", "Pt_v28_6", 0, 2.5)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_3_7;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_3_7", "v_{2}{8};v_{2}{8,veto}", "#splitline{pPb 8.16 TeV}{Ch 150 #leq N_{trk}^{offline} < 185}", "Pt_v28_7", 0, 2.5)'
#root -l -b -q 'plotS.C("../cumudiff/pPb_H_merged2_corrected.root:grSig_pT2_3_8;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pT2_3_8", "v_{2}{8};v_{2}{8,veto}", "#splitline{pPb 8.16 TeV}{Ch 185 #leq N_{trk}^{offline} < 250}", "Pt_v28_8", 0, 2.5)'
...
######### standard v2SP vs v22 vs vetoJet20eta20 vs vetoJet25eta20 vs vetoJet30eta20
#root -l -b -q 'plotS.C("../cumudiff/V0SP.root:ch_pPb_corrected_6/vn_Full_NegEtaEP;../cumudiff/pPb_H_merged2_corrected.root:grSig_pTGap2_6;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pTGap2_6;../cumudiff/pPb_H_vetoJet25eta20_merged2_corrected.root:grSig_pTGap2_6;../cumudiff/pPb_H_vetoJet30eta20_merged2_corrected.root:grSig_pTGap2_6", "v_{2}{SP};v_{2}{2, |#Delta#eta|>2.};v_{2}{2} p_{T,jet}>20;v_{2}{2} p_{T,jet}>25;v_{2}{2} p_{T,jet}>30", "#splitline{pPb 8.16 TeV}{Ch 120 #leq N_{trk}^{offline} < 150}", "Pt_v22vetoJet_6", 0, 0.5)'
#root -l -b -q 'plotS.C("../cumudiff/V0SP.root:ch_pPb_corrected_7/vn_Full_NegEtaEP;../cumudiff/pPb_H_merged2_corrected.root:grSig_pTGap2_7;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pTGap2_7;../cumudiff/pPb_H_vetoJet25eta20_merged2_corrected.root:grSig_pTGap2_7;../cumudiff/pPb_H_vetoJet30eta20_merged2_corrected.root:grSig_pTGap2_7", "v_{2}{SP};v_{2}{2, |#Delta#eta|>2.};v_{2}{2} p_{T,jet}>20;v_{2}{2} p_{T,jet}>25;v_{2}{2} p_{T,jet}>30", "#splitline{pPb 8.16 TeV}{Ch 150 #leq N_{trk}^{offline} < 185}", "Pt_v22vetoJet_7", 0, 0.5)'
#root -l -b -q 'plotS.C("../cumudiff/V0SP.root:ch_pPb_corrected_8/vn_Full_NegEtaEP;../cumudiff/pPb_H_merged2_corrected.root:grSig_pTGap2_8;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pTGap2_8;../cumudiff/pPb_H_vetoJet25eta20_merged2_corrected.root:grSig_pTGap2_8;../cumudiff/pPb_H_vetoJet30eta20_merged2_corrected.root:grSig_pTGap2_8", "v_{2}{SP};v_{2}{2, |#Delta#eta|>2.};v_{2}{2} p_{T,jet}>20;v_{2}{2} p_{T,jet}>25;v_{2}{2} p_{T,jet}>30", "#splitline{pPb 8.16 TeV}{Ch 185 #leq N_{trk}^{offline} < 250}", "Pt_v22vetoJet_8", 0, 0.5)'
#root -l -b -q 'plotS.C("../cumudiff/V0SP.root:ch_pPb_corrected_9/vn_Full_NegEtaEP;../cumudiff/pPb_H_merged2_corrected.root:grSig_pTGap2_9;../cumudiff/pPb_H_vetoJet20eta20_merged2_corrected.root:grSig_pTGap2_9;../cumudiff/pPb_H_vetoJet25eta20_merged2_corrected.root:grSig_pTGap2_9;../cumudiff/pPb_H_vetoJet30eta20_merged2_corrected.root:grSig_pTGap2_9", "v_{2}{SP};v_{2}{2, |#Delta#eta|>2.};v_{2}{2} p_{T,jet}>20;v_{2}{2} p_{T,jet}>25;v_{2}{2} p_{T,jet}>30", "#splitline{pPb 8.16 TeV}{Ch N_{trk}^{offline} #geq 250}",       "Pt_v22vetoJet_9", 0, 0.5)'
#
#
#root -l -b -q 'plotS.C("PbPb2018_H_corrected.root:grH_pTGap2_1;PbPb2018_H_corrected.root:grH_pT2_1_1;PbPb_v0_SP_corrected.root:ch_v2_PbPb_5_10/vn_MergedEta",  "v_{2}{2, Gap};v_{2}{SP}", "#splitline{PbPb 5.02 TeV}{ch 5-10\%}", "ch_5_vn", 0, 0.5)'
#root -l -b -q 'plotS.C("PbPb2018_H_corrected.root:grH_pTGap2_2;PbPb2018_H_corrected.root:grH_pT2_1_2;PbPb_v0_SP_corrected.root:ch_v2_PbPb_10_30/vn_MergedEta", "v_{2}{2, Gap};v_{2}{SP}", "#splitline{PbPb 5.02 TeV}{ch 10-30\%}", "ch_10_vn", 0, 0.5)'
#root -l -b -q 'plotS.C("PbPb2018_H_corrected.root:grH_pTGap2_3;PbPb2018_H_corrected.root:grH_pT2_1_3;PbPb_v0_SP_corrected.root:ch_v2_PbPb_30_50/vn_MergedEta", "v_{2}{2, Gap};v_{2}{SP}", "#splitline{PbPb 5.02 TeV}{ch 30-50\%}", "ch_30_vn", 0, 0.5)'
