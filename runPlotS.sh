...
root -l -b -q 'plotS.C("V0SP.root:Ks_pPb_corrected_8/vn_NegEta_PosEtaEP_SubEvt;V0SP.root:Ks_pPb_corrected_8/vn_PosEta_NegEtaEP_SubEvt", "K_{S}^{0} v_{2}^{Sig}{p-SP};K_{S}^{0} v_{2}^{Sig}{Pb-SP}", "185 #leq N_{trk}^{offline} < 250", "Ks_v2sp")'
...
root -l -b -q 'plotS.C("V0SP.root:ch_pPb_corrected_8/vn_NegEta_PosEtaEP_SubEvt;V0SP.root:ch_pPb_corrected_8/vn_PosEta_NegEtaEP_SubEvt", "ch v_{2}^{Sig}{p-SP};ch v_{2}^{Sig}{Pb-SP}", "185 #leq N_{trk}^{offline} < 250", "H_v2sp")'
...
root -l -b -q 'plotS.C("pPb_Ks2_merged2_corrected.root:grSig_V2sub4pos_8;V0SP.root:Ks_pPb_corrected_8/vn_NegEta_PosEtaEP_SubEvt;pPb_Ks2_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} Pb-side;v_{2}^{Sig}{p-SP};v_{2}^{Sig}{4} std", "#splitline{Pb-Side K_{S}^{0}}{185 #leq N_{trk}^{offline} < 250}", "Ks_PbSide", 1)'

root -l -b -q 'plotS.C("pPb_Ks2_merged2_corrected.root:grSig_V2sub4neg_8;V0SP.root:Ks_pPb_corrected_8/vn_PosEta_NegEtaEP_SubEvt;pPb_Ks2_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} p-side;v_{2}^{Sig}{Pb-SP};v_{2}^{Sig}{4} std", "#splitline{p-Side K_{S}^{0}}{185 #leq N_{trk}^{offline} < 250}", "Ks_pSide", 1)'





root -l -b -q 'plotS.C("pPb_Lm2_merged2_corrected.root:grSig_V2sub4pos_8;V0SP.root:Lm_pPb_corrected_8/vn_NegEta_PosEtaEP_SubEvt;pPb_Lm2_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} Pb-side;v_{2}^{Sig}{p-SP};v_{2}^{Sig}{4} std", "#splitline{Pb-Side #Lambda}{185 #leq N_{trk}^{offline} < 250}", "Lm_PbSide", 1)'

root -l -b -q 'plotS.C("pPb_Lm2_merged2_corrected.root:grSig_V2sub4neg_8;V0SP.root:Lm_pPb_corrected_8/vn_PosEta_NegEtaEP_SubEvt;pPb_Lm2_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} p-side;v_{2}^{Sig}{Pb-SP};v_{2}^{Sig}{4} std", "#splitline{p-Side #Lambda}{185 #leq N_{trk}^{offline} < 250}", "Lm_pSide", 1)'





root -l -b -q 'plotS.C("pPb_H_merged2_corrected.root:grSig_V2sub4pos_8;V0SP.root:ch_pPb_corrected_8/vn_NegEta_PosEtaEP_SubEvt;pPb_H_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} Pb-side;v_{2}^{Sig}{p-SP};v_{2}^{Sig}{4} std", "#splitline{Pb-Side ch}{185 #leq N_{trk}^{offline} < 250}", "H_PbSide", 1)'

root -l -b -q 'plotS.C("pPb_H_merged2_corrected.root:grSig_V2sub4neg_8;V0SP.root:ch_pPb_corrected_8/vn_PosEta_NegEtaEP_SubEvt;pPb_H_merged2_corrected.root:grSig_pT2_1_8", "v_{2}^{Sig}{4, 2sub} p-side;v_{2}^{Sig}{Pb-SP};v_{2}^{Sig}{4} std", "#splitline{p-Side ch}{185 #leq N_{trk}^{offline} < 250}", "H_pSide", 1)'
