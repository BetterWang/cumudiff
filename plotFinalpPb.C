...
//    SetStyle();
    ...
    TLatex latexU;
    latexU.SetTextFont(43);
    latexU.SetTextSize(26);
    latexU.SetTextAlign(13);
...
//            DropPoints( grSysChDeltaCu1[c], -1 );
            ...
            DropPoints( grKs.gr_v24sub[c], 1 );
            DropPoints( grKs.grSys_v24sub[c], 1 );
//            DropPoints( grKs.gr_v24sub[c], -1 );
            DropPoints( grKsRatioCu1[c],   1 );
            DropPoints( grKsRatioCu1[c],   -1 );
            DropPoints( grSysKsRatioCu1[c],   1 );
...
//            DropPoints( grLm.gr_v24[c],    -1 );
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr(grH.gr_v24[c], kOpenStar,  kRed, 2.);
        setGr(grH.gr_v26[c], kOpenCross, kBlue,  2.);
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{Charged hadron}");
    latexU.DrawLatexNDC(0.20, 0.90, strNoff[6]);

    TLegend * legCh0 = new TLegend(0.65, 0.75, 0.95, 0.91);
    ...
    TLegend * legCh1 = new TLegend(0.65, 0.670, 0.95, 0.91);
    ...
    cpPbV2->cd(2);
    latexU.DrawLatexNDC(0.08, 0.90, strNoff[7]);
    cpPbV2->cd(3);
    latexU.DrawLatexNDC(0.08, 0.90, strNoff[8]);
    legCh0->Draw();
    cpPbV2->cd(4);
    latexS.DrawLatexNDC(0.55, 0.99, "pPb 8.16 TeV");
    latexU.DrawLatexNDC(0.08, 0.90, strNoff[9]);
    legCh1->Draw();
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr(grKs.gr_v24[c], kOpenStar,  kRed, 2.);
        setGr(grKs.gr_v26[c], kOpenCross, kBlue,  2.);

        grKs.grSys_v24[c]->SetFillColor(3001);
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{K_{S}^{0}}");
    latexU.DrawLatexNDC(0.20, 0.90, strNoff[6]);

    TLegend * legKs0 = new TLegend(0.65, 0.75, 0.95, 0.91);
    ...
    TLegend * legKs1 = new TLegend(0.65, 0.75, 0.95, 0.91);
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr(grLm.gr_v24[c], kOpenStar,  kRed, 2.);
        setGr(grLm.gr_v26[c], kOpenCross, kBlue,  2.);

        grLm.grSys_v24[c]->SetFillColor(3001);
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{#Lambda}");
    ...
    TLegend * legLm0 = new TLegend(0.65, 0.75, 0.95, 0.91);
    ...
    TLegend * legLm1 = new TLegend(0.65, 0.75, 0.95, 0.91);
    ...
    // fluctuation
    TH2D * hframe_fluct = new TH2D("hframe_fluct", "hframe_fluct", 1, 0.01, 8.5, 1, 0.05, 1.49);
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{Charged hadron}");
    ...
    TLegend * legFl6 = new TLegend(0.50, 0.72, 0.90, 0.91);
...
//    legChSub0->Draw();
    ...
    cpPbV2->cd(2);
    latexU.DrawLatexNDC(0.08, 0.90, strNoff[7]);
    TLegend * legChSub1 = new TLegend(0.55, 0.75, 0.98, 0.91);
...
//        grChRatioCu3[c]->Draw("psame");
    ...
    TLegend * legChRatio1 = new TLegend(0.45, 0.68, 0.98, 0.91);
...
//    legChRatio1->AddEntry( grChRatioCu3[6], "v_{2}{4,Sub} -1.<#eta<0.", "p" );
    ...
    TLegend * legChDelta1 = new TLegend(0.45, 0.68, 0.98, 0.91);
...
//        grKsRatioCu3[c]->Draw("psame");
        s2f.WriteGr( grSysKsRatioCu1[c], Form( "grKs_v24subRatioSys_%i", c ) );
...
//        grLmRatioCu3[c]->Draw("psame");
        s2f.WriteGr( grSysLmRatioCu1[c], Form( "grLm_v24subRatioSys_%i", c ) );
...
//    legLmRatio1->AddEntry( grLmRatioCu3[6], "v_{2}{4,Sub} -1.<#eta<0.", "p" );
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr( grH.gr_v24    [c], kOpenStar, kRed, 2. );
        setGr( grHveto.gr_v24[c], kFullStar, kRed, 2. );

        setGr( grH.gr_v26    [c], kOpenCross, kBlue, 2. );
        setGr( grHveto.gr_v26[c], kFullCross, kBlue,  2. );
        ...
        s2f.WriteGr( grHveto.grSys_v24[c], Form( "grChSys_v24veto_%i", c ) );
        s2f.WriteGr( grHveto.grSys_v26[c], Form( "grChSys_v26veto_%i", c ) );
    }
    cpPbV2->cd(1);
    if ( bPre ) {
        latexS.DrawLatexNDC(0.12, 0.99, "#bf{CMS #it{Preliminary}}");
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{Charged hadron}");
    ...
    TLegend * legChVeto = new TLegend(0.50, 0.58, 0.95, 0.91);
...
//    legChVeto->AddEntry( grHveto.gr_v22Gap[6], "v_{2}{2, veto,|#Delta#eta|>2.}", "p" );
    ...
    TLegend * legKsVeto = new TLegend(0.45, 0.58, 0.90, 0.91);
    ...
    TLegend * legLmVeto = new TLegend(0.45, 0.58, 0.90, 0.91);
    ...
    hframe_ratioVeto->GetXaxis()->SetTitleOffset(1.0);
    hframe_ratioVeto->GetYaxis()->SetTitleOffset(1.2);

    hframe_ratioVeto->GetXaxis()->SetTitleFont(43);
    hframe_ratioVeto->GetYaxis()->SetTitleFont(43);
    hframe_ratioVeto->GetXaxis()->SetLabelFont(43);
    hframe_ratioVeto->GetYaxis()->SetLabelFont(43);

    hframe_ratioVeto->GetXaxis()->SetTitleSize(25);
    hframe_ratioVeto->GetXaxis()->SetLabelSize(23);

    hframe_ratioVeto->GetYaxis()->SetTitleSize(25);
    hframe_ratioVeto->GetYaxis()->SetLabelSize(23);
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr( grChRatioVeto4[c], kOpenStar,  kRed, 2. );
        setGr( grChRatioVeto6[c], kOpenCross, kBlue,  2. );
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{Charged hadron}");
    ...
    TLegend * legChVetoRatio = new TLegend(0.45, 0.75, 0.98, 0.91);
...
//    legChVetoRatio->AddEntry( grChRatioVeto2[6], "v_{2}{2,veto}/v_{2}{2}", "p" );
    ...
    hframe_pt_deltaVeto->GetXaxis()->SetTitleOffset(1.0);
    hframe_pt_deltaVeto->GetYaxis()->SetTitleOffset(1.2);

    hframe_pt_deltaVeto->GetXaxis()->SetTitleFont(43);
    hframe_pt_deltaVeto->GetYaxis()->SetTitleFont(43);
    hframe_pt_deltaVeto->GetXaxis()->SetLabelFont(43);
    hframe_pt_deltaVeto->GetYaxis()->SetLabelFont(43);

    hframe_pt_deltaVeto->GetXaxis()->SetTitleSize(25);
    hframe_pt_deltaVeto->GetXaxis()->SetLabelSize(23);

    hframe_pt_deltaVeto->GetYaxis()->SetTitleSize(25);
    hframe_pt_deltaVeto->GetYaxis()->SetLabelSize(23);
    ...
    for ( int c = 6; c < 10; c++ ) {
        ...
        setGr( grChVetoDelta4[c], kOpenStar,  kRed, 2. );
        setGr( grChVetoDelta6[c], kOpenCross, kBlue,  2. );
...
//    latexT.DrawLatexNDC(0.20, 0.80, "#bf{Charged hadron}");
    ...
    legChVetoDelta->AddEntry( grChVetoDelta4[6], "v_{2}{4,veto} - v_{2}{4}", "p" );
    legChVetoDelta->AddEntry( grChVetoDelta6[6], "v_{2}{6,veto} - v_{2}{6}", "p" );
    ...
    hframe_ratioPosNeg->GetXaxis()->SetTitleOffset(1.0);
    hframe_ratioPosNeg->GetYaxis()->SetTitleOffset(1.2);

    hframe_ratioPosNeg->GetXaxis()->SetTitleFont(43);
    hframe_ratioPosNeg->GetYaxis()->SetTitleFont(43);
    hframe_ratioPosNeg->GetXaxis()->SetLabelFont(43);
    hframe_ratioPosNeg->GetYaxis()->SetLabelFont(43);

    hframe_ratioPosNeg->GetXaxis()->SetTitleSize(25);
    hframe_ratioPosNeg->GetXaxis()->SetLabelSize(23);

    hframe_ratioPosNeg->GetYaxis()->SetTitleSize(25);
    hframe_ratioPosNeg->GetYaxis()->SetLabelSize(23);
