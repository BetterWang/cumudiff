...
int TMVAClassification_full5( string s = "LM" )
{
   ...
   TString outfileName( (string("TMVA5_HydjetMCTruth_MCBkg_")+s+".root").c_str() ); // change
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset5_full_")+s).c_str() ); // change
