...
int TMVAClassification_DataSBFull( string s = "LM" )
{
   ...
   TString outfileName( (string("TMVA_HydjetMCTruth_DataSBFull_")+s+".root").c_str() );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset_dataSB_Full_")+s).c_str() );
