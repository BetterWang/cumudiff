...
int TMVAClassification_DataSB( string s = "LM" )
{
   ...
   TFile *inputB = new TFile( (string("../../PbPb2018/V0Performance/MB4SB_")+s+"_rap1.root").c_str() );
   ...
   TString outfileName( (string("TMVA_HydjetMCTruth_DataSB_")+s+".root").c_str() );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset_dataSB_rap1_")+s).c_str() );
