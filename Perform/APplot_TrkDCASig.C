...
void APplot_TrkDCASig(string prefix = "LM", string input = "../../PbPb2018/HIMinimumBias4/crab_HIMB4_V0Tree_v8/191011_032855/0000/*.root/tree/trV", string fout = "LM.root", Float_t BDTCut = 0.1, string xml = "", double DCASig = 20.)
{
    TMVA::Tools::Instance();
    ...
    while (trV->GetEntry(ievt)) {
        ...
        for ( int i = 0; i < n; i++ ) {
            ...
            if ( (pTrkDCASigXY > DCASig) or (pTrkDCASigZ > DCASig) or (nTrkDCASigXY > DCASig) or (nTrkDCASigZ > DCASig) ) continue;
