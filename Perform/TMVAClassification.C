...
int TMVAClassification( string s = "LM" )
{
   ...
   TString outfileName( (string("TMVA_HydjetMCTruth_MCBkg_")+s+".root").c_str() );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset_rap1_")+s).c_str() );
