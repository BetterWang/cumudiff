...
void filter_mass3_cent(string prefix = "LM", string input = "../../PbPb2018/HIMinimumBias4/crab_HIMB4_V0Tree_v9/200909_044330/0000/*.root/tree/trV", string fout = "LM.root", bool bForward = false)
{
    TMVA::Tools::Instance();
    ...
    readerC->BookMVA( string("BDT_MCfull4_cent0"),    string("dataset3_full_")+prefix+"_0/weights/TMVAClassification_BDT250_D4.weights.xml");
    readerC->BookMVA( string("BDT_MCfull4_cent1"),    string("dataset3_full_")+prefix+"_1/weights/TMVAClassification_BDT250_D4.weights.xml");
    readerC->BookMVA( string("BDT_MCfull4_cent2"),    string("dataset3_full_")+prefix+"_2/weights/TMVAClassification_BDT250_D4.weights.xml");
    readerC->BookMVA( string("BDT_MCfull4_cent3"),    string("dataset3_full_")+prefix+"_3/weights/TMVAClassification_BDT250_D4.weights.xml");
    readerC->BookMVA( string("BDT_MCfull4_cent4"),    string("dataset3_full_")+prefix+"_4/weights/TMVAClassification_BDT250_D4.weights.xml");

    Float_t BDT_MCfull = 0.;
    Float_t BDT_MCfull4= 0.;
    Float_t BDT_MCfull4_cent = 0.;
    ...
    mtr->Branch("BDT_MCfull4_cent", &BDT_MCfull4_cent,  "BDT_MCfull4_cent/F" );
    ...
    while (trV->GetEntry(ievt)) {
        ...
        for ( int i = 0; i < n; i++ ) {
            ...
            if ( Cent < 10. ) {
                BDT_MCfull4_cent = readerC->EvaluateMVA( "BDT_MCfull4_cent0" );
            } else if ( Cent >= 10. and Cent < 20. ) {
                BDT_MCfull4_cent = readerC->EvaluateMVA( "BDT_MCfull4_cent1" );
            } else if ( Cent >= 20. and Cent < 60. ) {
                BDT_MCfull4_cent = readerC->EvaluateMVA( "BDT_MCfull4_cent2" );
            } else if ( Cent >= 60. and Cent < 100. ) {
                BDT_MCfull4_cent = readerC->EvaluateMVA( "BDT_MCfull4_cent3" );
            } else if ( Cent >= 100. and Cent < 160. ) {
                BDT_MCfull4_cent = readerC->EvaluateMVA( "BDT_MCfull4_cent4" );
            }
            mtr->Fill();
        }
        ievt++;
