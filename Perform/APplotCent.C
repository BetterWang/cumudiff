...
void APplotCent(string prefix = "LM", string input = "", string fout = "LM.root", Float_t BDTCut = 0.1 )
{
    TMVA::Tools::Instance();
...
//    reader->AddVariable( "Cent",             &Cent           );
    ...
    reader->AddSpectator( "Cent",   &Cent);

    reader->BookMVA( string("BDT_MCfull4_cent0"),    string("dataset3_full_")+prefix+"_0/weights/TMVAClassification_BDT250_D4.weights.xml");
    reader->BookMVA( string("BDT_MCfull4_cent1"),    string("dataset3_full_")+prefix+"_1/weights/TMVAClassification_BDT250_D4.weights.xml");
    reader->BookMVA( string("BDT_MCfull4_cent2"),    string("dataset3_full_")+prefix+"_2/weights/TMVAClassification_BDT250_D4.weights.xml");
    reader->BookMVA( string("BDT_MCfull4_cent3"),    string("dataset3_full_")+prefix+"_3/weights/TMVAClassification_BDT250_D4.weights.xml");
    reader->BookMVA( string("BDT_MCfull4_cent4"),    string("dataset3_full_")+prefix+"_4/weights/TMVAClassification_BDT250_D4.weights.xml");
    ...
    while (trV->GetEntry(ievt)) {
        ...
        for ( int i = 0; i < n; i++ ) {
            ...
            BDT_MCfull4_cent = -0.99;
            if ( Cent < 10. ) {
                BDT_MCfull4_cent = reader->EvaluateMVA( "BDT_MCfull4_cent0" );
            } else if ( Cent >= 10. and Cent < 20. ) {
                BDT_MCfull4_cent = reader->EvaluateMVA( "BDT_MCfull4_cent1" );
            } else if ( Cent >= 20. and Cent < 60. ) {
                BDT_MCfull4_cent = reader->EvaluateMVA( "BDT_MCfull4_cent2" );
            } else if ( Cent >= 60. and Cent < 100. ) {
                BDT_MCfull4_cent = reader->EvaluateMVA( "BDT_MCfull4_cent3" );
            } else if ( Cent >= 100. and Cent < 160. ) {
                BDT_MCfull4_cent = reader->EvaluateMVA( "BDT_MCfull4_cent4" );
            }

            if ( BDT_MCfull4_cent > BDTCut ) {
