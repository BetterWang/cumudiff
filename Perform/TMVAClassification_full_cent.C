...
// 3 - 60-100  30-50%
// 4 - 100-160 50-80%
int TMVAClassification_full_cent( string s = "LM", int centS = -1 )
{
   ...
   TString outfileName( (string("TMVA3_HydjetMCTruth_MCBkg_")+s+"_"+to_string(centS)+".root").c_str() ); // change
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset3_full_")+s+"_"+to_string(centS)).c_str() ); // change
...
//   TCut mycutb = "fabs(rapidity)<1.0"; // for example: TCut mycutb = "abs(var1)<0.5";
   ...
   if ( centS == 1 ) {
       mycuts = "(Cent>=10) && (Cent<20)";
       mycutb = "(Cent>=10) && (Cent<20)";
   }
   if ( centS == 2 ) {
       mycuts = "(Cent>=20) && (Cent<60)";
       mycutb = "(Cent>=20) && (Cent<60)";
   }
   if ( centS == 3 ) {
       mycuts = "(Cent>=60) && (Cent<100)";
       mycutb = "(Cent>=60) && (Cent<100)";
   }
   if ( centS == 4 ) {
       mycuts = "(Cent>=100) && (Cent<160)";
       mycutb = "(Cent>=100) && (Cent<160)";
   }
