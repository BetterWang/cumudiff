
{
    ...
    leg->AddEntry(hAcc_eta_0_10,   "0-10% 1.8<p_{T}<8.5", "p");
    leg->AddEntry(hAcc_eta_10_30, "10-30% 1.8<p_{T}<8.5", "p");
    ...
    hREC_pT12_0_10->GetYaxis()->SetRangeUser(0, 0.1);
    ...
    hEff_pT12_0_10->GetYaxis()->SetRangeUser(0, 0.1);
    ...
    hFak_pT12_0_10->GetYaxis()->SetRangeUser(0, 1.2);
