...
void filter_mass(string prefix = "LM", string input = "../../PbPb2018/HIMinimumBias4/crab_HIMB4_V0Tree_v6/190917_195729/0000/*.root/tree/trV", string fout = "LM.root")
{
    TMVA::Tools::Instance();
    ...
    for ( string s : {"BDT250_D2", "BDT250_D3", "BDT500_D2", "BDT500_D3", "BDT850_D3", "BDTG1000_D2", "BDTG250_D2", "BDTG250_D3", "LD"} ) {
        reader->BookMVA( s, string("dataset_full_")+prefix+"/weights/TMVAClassification_"+s+".weights.xml" );
    }
    ...
    Float_t BDT500_D3 = 0.;
    Float_t BDT850_D3 = 0.;
    Float_t BDTG1000_D2 = 0.;
    Float_t BDTG250_D2 = 0.;
    Float_t BDTG250_D3 = 0.;
    Float_t LD = 0.;
...
//    mtr->Branch("LD",           &LD,               "LD/F" );
//    mtr->Branch("BDT250_D2",    &BDT250_D2,        "BDT250_D2/F" );
    mtr->Branch("BDT250_D3",    &BDT250_D3,        "BDT250_D3/F" );
//    mtr->Branch("BDT500_D2",    &BDT500_D2,        "BDT500_D2/F" );
//    mtr->Branch("BDT500_D3",    &BDT500_D3,        "BDT500_D3/F" );
//    mtr->Branch("BDT850_D3",    &BDT850_D3,        "BDT850_D3/F" );
//    mtr->Branch("BDTG250_D2",   &BDTG250_D2,       "BDTG250_D2/F" );
//    mtr->Branch("BDTG250_D3",   &BDTG250_D3,       "BDTG250_D3/F" );
//    mtr->Branch("BDTG1000_D2",  &BDTG1000_D2,      "BDTG1000_D2/F" );
...
//            LD          = reader->EvaluateMVA( "LD"          );
//            BDT250_D2   = reader->EvaluateMVA( "BDT250_D2"   );
            BDT250_D3   = reader->EvaluateMVA( "BDT250_D3"   );
//            BDT500_D2   = reader->EvaluateMVA( "BDT500_D2"   );
//            BDT500_D3   = reader->EvaluateMVA( "BDT500_D3"   );
//            BDT850_D3   = reader->EvaluateMVA( "BDT850_D3"   );
//            BDTG1000_D2 = reader->EvaluateMVA( "BDTG1000_D2" );
//            BDTG250_D2  = reader->EvaluateMVA( "BDTG250_D2"  );
//            BDTG250_D3  = reader->EvaluateMVA( "BDTG250_D3"  );
