...
void countN(string prefix = "LM", string input = "", string fout = "", double BDTcut = 0.15)
{
    TMVA::Tools::Instance();
    ...
    trV->SetBranchAddress( "EventId",                         &t_EventId);

    TH1D * hCent1 = new TH1D("hCent1", "hCent1", 200, 0, 200);
    TH1D * hCent2 = new TH1D("hCent2", "hCent2", 200, 0, 200);
...
//            if ( prefix == "LM" ) {
//                if ( mass < 1.1115 ) continue;
//                if ( mass > 1.1200 ) continue;
//            }
//            if ( prefix == "KS" ) {
//                if ( mass < 0.492 ) continue;
//                if ( mass > 0.503 ) continue;
//            }
