...
int TMVAClassification_full7( string s = "LM" )
{
   ...
   TString outfileName( (string("TMVA7_HydjetMCTruth_MCBkg_")+s+".root").c_str() ); // change
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader( (string("dataset7_full_")+s).c_str() ); // change
...
//   dataloader->AddVariable( "nTrkNPxLayer",     'I' );
   ...
   dataloader->AddSpectator( "pTrkNHit" );
   dataloader->AddSpectator( "nTrkNHit" );
